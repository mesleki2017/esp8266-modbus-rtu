...
void loop() {
   ...
   if (!mb.slave()) {
    ...
    Serial.println(error_code);
     ...
     delay(100);
       if (error_code==0){
    Serial.print("cihaz bulundu. BaudRate= ");Serial.print(myBaud[tarama_no]);
    Serial.print(" ,party = ");Serial.print(myPar[0]);
    Serial.print(" ,cihaz id = ");Serial.println(cihaz_id);
    ...
    if(cihaz_id==10){
      ...
      S.begin(myBaud[tarama_no],myPar[0]);
      }
    Serial.print("cihaz_id ");Serial.print(cihaz_id);
    Serial.print(" myBaud ");Serial.print(myBaud[tarama_no]);
    Serial.print(" par ");Serial.println(myPar[0]);
    }
  };
