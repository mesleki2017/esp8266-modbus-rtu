...
void loop() {
  ...
  if (!mb.slave()) {
    Serial.print("my_array_size ");Serial.println(my_array_size);
    int start_register=30400;
    mb.readHreg(3,start_register, Mread0,my_array_size-2, cbWrite);  //klemsan pdf (20 Phase 2 Voltage (L-N) float RO
